    ...
    <div className="flex min-h-screen bg-neutral-50">
      ...
      <aside className="hidden w-64 flex-col border-r border-neutral-200 bg-white lg:flex">
        ...
        <nav className="flex-1 space-y-1 p-4">
          ...
          <NavLink to="/admin/courses" end className={({ isActive }) => `flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors ${isActive ? 'bg-primary-50 text-primary-700' : 'text-neutral-600 hover:bg-neutral-100 hover:text-neutral-900'}`}>
