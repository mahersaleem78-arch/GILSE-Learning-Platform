...
export interface Payment { id:string; student_id:string; course_id:string; amount:number; currency:string; asset:string; network:string; wallet_address:string; method?:PaymentMethod; status:PaymentStatus; tx_hash:string|null; verification_error?:string|null; referral_code?:string|null; created_at:string; updated_at:string; verified_at?:string|null }
